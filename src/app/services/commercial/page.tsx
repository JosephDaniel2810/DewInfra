...
import { Building2, Users, Clock, Award, CheckCircle, ArrowRight } from 'lucide-react'
...
const CommercialConstructionPage = () => {
  const features = [
    "Modern office complexes and corporate headquarters",
  ...
  const process = [
    {
      ...
      description: "Comprehensive site analysis, feasibility studies, and detailed project planning",
      icon: "📋"
    },
    {
      step: "02", 
      title: "Design & Engineering",
      description: "Architectural design, structural engineering, and construction documentation",
      icon: "✏️"
    },
    {
      step: "03",
      title: "Construction",
      description: "Expert construction with quality control and timeline management",
      icon: "🏗️"
    },
    {
      step: "04",
  ...
  const stats = [
    { icon: Building2, value: "150+", label: "Commercial Projects" },
            ...
            >
              <motion.div variants={itemVariants} className="mb-6">
                <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6">
                  Commercial <span className="gradient-text">Construction</span>
                </h1>
                <p className="text-xl text-gray-300 leading-relaxed">
                  Building the future of business with state-of-the-art commercial facilities that inspire, 
                  function, and exceed expectations.
                </p>
              </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From modern office complexes to retail centers, we deliver commercial construction 
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A proven methodology that ensures every commercial construction project is delivered 
