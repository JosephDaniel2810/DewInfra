        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-1">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-2xl font-display font-bold text-white">DewInfra</h3>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm"
                />
                <button className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-r-lg transition-colors duration-300 text-sm">
                  Subscribe
                </button>
              </div>
            </div>
